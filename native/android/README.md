...
authenticate through the Native Gateway, and store refresh material using Android Keystore-backed
encrypted storage. `ACCESS_FINE_LOCATION` and background location are intentionally absent.
