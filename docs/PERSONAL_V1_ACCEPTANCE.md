...
| Security and recovery | Auth/role denial, safe logs, pinned release, rollback, successful isolated restore with recovery timings | The [2026-09-06 isolated restore drill](releases/2026-09-06-isolated-restore-drill.md) passed; recurring cadence, replacement of the exposed-passphrase backup, and remaining release-security evidence stay open. See [known risks](KNOWN_RISKS.md). |
