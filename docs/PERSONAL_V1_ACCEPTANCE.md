...
| Finance and calendar workspaces | Avanza/Crypto positions remain private and non-transactional; per-currency values and stale/unpriced states are honest; Calendar is Monday-first with weekend distinction, all-day safety and bounded governed reads | The [schema-0.42 staging release](releases/2026-09-07-a7601b7-staging.md) records a fresh encrypted backup, full isolated restore, migration rehearsal, applied migration, coordinated backend/web rollout, live authority checks, and a synthetic Finance create/edit journey. Calendar layout passed, but its governed provider read failed safely and remains open. The synthetic Finance archive, Android phone/tablet, installed-Windows owner checks, and stability evidence are also outstanding; automatic market quotes are not part of this release |
