...
| OM-009 | Operationalize backup verification and restore testing | [Memory Storage Policy](../memory/storage-policy.md#40-backup-verification) and [Security & Privacy Policy](../system/security-policy.md#71-backup-verification) require verification and recovery controls. The [2026-09-06 isolated drill](releases/2026-09-06-isolated-restore-drill.md) proves authenticated restoration of the pre-037 backup, forward migration from schema 0.36 to 0.39, unchanged canonical counts, and authority-boundary validation without a plaintext dump. | Approve and exercise a recurring operator cadence; replace and retire the backup whose passphrase was exposed during troubleshooting. |
