...
| OM-009 | Operationalize backup verification and restore testing | [Memory Storage Policy](../memory/storage-policy.md#40-backup-verification) and [Security & Privacy Policy](../system/security-policy.md#71-backup-verification) require verification and recovery controls. The [2026-09-05 staging release](releases/2026-09-05-a864076-staging.md#database-gate) records an authenticated encrypted logical backup and readable archive catalogue; it does not prove restoration. A fail-closed [encrypted restore tool](../memory/backup-tools/README.md) now makes the isolated drill repeatable without writing a plaintext dump. | A successful isolated non-production restore drill with dated RPO/RTO findings and an approved recurring operator cadence. |
